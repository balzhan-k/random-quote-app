export const QuoteCard = ({ quote, author, likeCount }) => {
  return (
    <section className="QuoteCard">
      <div className="text-green-700 text-xl flex items-center justify-center gap-2 flex-wrap text-center">
        <svg
          ...
          fill="currentColor"
          viewBox="0 0 256 256"
          className="text-green-700 inline-block rotate-180"
        >
        ...
        <p className="text-green-700 text-xl inline">{quote}</p>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="32"
          height="32"
      ...
      <p className="mt-2 text-right text-xs tracking-wide text-green-700">
        {author}
      </p>
