...
export const CreateQuoteForm = ({ onCreate, onCancel }: CreateQuoteFormProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50 p-4">
      <div className="bg-white p-6 sm:p-8 rounded-lg shadow-xl w-full max-w-sm sm:max-w-md mx-auto relative">
        <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-gray-800 text-center">Create New Quote</h2>
        <form onSubmit={handleSubmit}>
          <div className="mb-3 sm:mb-4">
            <label htmlFor="quote" className="block text-gray-700 text-sm sm:text-base font-bold mb-1 sm:mb-2">Quote:</label>
            <textarea
              id="quote"
          ...
          <div className="mb-4 sm:mb-6">
            <label htmlFor="author" className="block text-gray-700 text-sm sm:text-base font-bold mb-1 sm:mb-2">Author:</label>
            <input
              type="text"
              id="author"
