...
export const QuoteIndexDispatchContext = createContext<React.Dispatch<
  React.SetStateAction<number>
> | null>(null);

export const QuoteIndexContextProvider = ({
  children,
}: {
...
export const useQuoteIndexContext = () =>
  useContext(QuoteIndexContext as React.Context<number>);
export const useQuoteIndexDispatchContext = () =>
  useContext(
    QuoteIndexDispatchContext as React.Context<
